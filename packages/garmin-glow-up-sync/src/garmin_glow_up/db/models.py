...
class DailyMetric(Base):
    ...
    body_battery_intraday: Mapped[str | None] = mapped_column(Text)
    stress_avg: Mapped[int | None] = mapped_column(Integer)
    stress_rest_s: Mapped[int | None] = mapped_column(Integer)
    stress_low_s: Mapped[int | None] = mapped_column(Integer)
    stress_med_s: Mapped[int | None] = mapped_column(Integer)
    stress_high_s: Mapped[int | None] = mapped_column(Integer)
